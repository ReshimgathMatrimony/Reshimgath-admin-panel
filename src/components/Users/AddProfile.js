...
const AddProfile = () => {
  ...
  const handleState = (event) => {
    axios
      .get(
        `https://api.countrystatecity.in/v1/countries/${countriesName}/states/${
  ...
  const handleRegister = (e) => {
    ...
    setMail(data1.email)
    axios
      .post(`${process.env.REACT_APP_BASEURL}/admincrud/register`, data1, {
        headers: {
  ...
  const handlePersonalInfo = async (e) => {
    ...
    const payLoad = {
      ...data2,
      email: mail,
      image1: await imageFormator(data2.image1),
      image2: await imageFormator(data2.image2),
      image3: await imageFormator(data2.image3),
      country_name: data2.country_name.split(",")[1],
      state_name: data2.state_name.split(",")[1],
    }
    axios
      .post(
        `${process.env.REACT_APP_BASEURL}/admincrud/getbasicinfo`,
        payLoad,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handleFamilyInfo = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_BASEURL}/admincrud/getfamilydetails`,
        payLoad,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handlePartnerInfo = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_BASEURL}/admincrud/getpartnerprefrencenewadd`,
        payLoad,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handleHoroscope = (e) => {
    ...
    axios
      .post(
        `${process.env.REACT_APP_BASEURL}/admincrud/gethoroscopedetails`,
        payLoad,
        {
          headers: {
            "Content-Type": "application/json",
        ...
        {registerdata ? (
          <div className="row d-flex justify-content-center result_row">
            <div className="col-lg-10 result_profile_div">
              ...
              <h4 className="result_profile_title">
                1. Basic Registration Completed
              </h4>
            </div>
          </div>
        ) : (
          <div className="row d-flex justify-content-center mt-4">
            <div className="col-lg-10 outer_form_div">
              <p style={{ color: "red" }}>
                *Please Add All Form Details in Only One Go.
              </p>
              ...
              <form onSubmit={handleRegister} autoComplete="off">
                ...
                <div className="col-lg-12 input-group mb-3">
                  ...
                  >
                    {" "}
                    {pass ? (
                      <img src={HiddenEyeIcon} alt="Image" />
                    ) : (
                      <img src={eyeIcon} alt="Image" />
                    )}
                  </span>
                </div>
        ...
        {personalinfo ? (
          <div className="row d-flex justify-content-center result_row">
            <div className="col-lg-10 result_profile_div">
              <img src={completeIcon} alt="image" />
              <h4 className="result_profile_title">
                2. Personal Information Submitted
              </h4>
            </div>
          </div>
        ) : (
                ...
                <div className="row mb-5">
                  <div className="col-lg-4 mb-4">
                    ...
                    >
                      ...
                      {country?.map((val, id) => {
                        return (
                          <option value={`${val.iso2},${val.name}`}>
                            {val.name}
                          </option>
                        )
                      })}
                  ...
                  <div className="col-lg-4 mb-4">
                    ...
                    >
                      ...
                      {stateData?.map((value, index) => {
                        return (
                          <option value={`${value.iso2},${value.name}`}>
                            {value.name}
                          </option>
                        )
                      })}
        ...
        {familyinfo ? (
          <div className="row d-flex justify-content-center result_row">
            <div className="col-lg-10 result_profile_div">
              <img src={completeIcon} alt="image" />
              <h4 className="result_profile_title">
                3. Family Information Submitted
              </h4>
            </div>
          </div>
        ) : (
              ...
              <form onSubmit={handleFamilyInfo}>
                <div className="row">
                  ...
                  <div className="col-lg-6 d-flex mb-3">
                    ...
                    <div
                      className="btn-group me-2 fathers_occupation_group"
                      role="group"
                    ...
                    >
                      ...
                      />
                      &nbsp;
                      <span style={{ marginTop: "2%", marginLeft: "1%" }}>
                        Job&emsp;
                      </span>
                      &nbsp;
                      <input
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-12 d-flex mb-3">
                    ...
                    <div
                      className="btn-group me-2 mothers_occupation_group"
                      role="group"
                      aria-label="Second group"
                    >
                      &nbsp;
                ...
                <div className="row">
                  <div className="col-lg-3 d-flex mb-4">
                    <label htmlFor="bother_select" style={{ color: "black" }}>
                      Brothers&emsp;
                    </label>
                    <select
                      className="form-select form-select"
                  ...
                  <div className="col-lg-3 d-flex mb-4">
                    <label htmlFor="bother_status" style={{ color: "black" }}>
                      Married&emsp;
                    </label>
                    <select
                      className="form-select form-select"
                  ...
                  <div className="col-lg-3 d-flex mb-4">
                    <label htmlFor="sister_select" style={{ color: "black" }}>
                      Sisters&emsp;
                    </label>
                    <select
                      className="form-select form-select"
                  ...
                  <div className="col-lg-3 d-flex mb-4">
                    <label htmlFor="sister_status" style={{ color: "black" }}>
                      Married&emsp;
                    </label>
                    <select
                      className="form-select form-select"
        ...
        {partnerinfo ? (
          <div className="row d-flex justify-content-center result_row">
            <div className="col-lg-10 result_profile_div">
              <img src={completeIcon} alt="image" />
              <h4 className="result_profile_title">
                4. Partner Preference Details Submitted
              </h4>
            </div>
          </div>
        ) : (
                ...
                <div className="row">
                  <div className="col-lg-4 mb-4">
                    ...
                    >
                      ...
                      {educationdata?.map((val, id) => {
                        return (
                          <option key={id} value={val.education}>
                            {val.education}
                          </option>
                        )
                      })}
                    ...
                    />
                    {/* {console.log("Education:", JSON.stringify(selected))} */}
                  </div>
        ...
        {horoscopinfo ? (
          <div className="row d-flex justify-content-center result_row">
            <div className="col-lg-10 result_profile_div">
              <img src={completeIcon} alt="image" />
              <h4 className="result_profile_title">
                5. Horoscopic Information Submitted
              </h4>
            </div>
          </div>
        ) : (
