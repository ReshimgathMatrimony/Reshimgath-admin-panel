      ...
      <div className="col-lg-9">
        ...
        <div classNameNameName="container">
          ...
          <form className='mt-5 createplan_div p-3' onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="mb-4">
              <input type="number" name='contact_count' placeholder='Count of Profile Views' className="form-control" aria-describedby="emailHelp" required />
            </div>

            <div className="mb-4">
              <input type="number" name='expiresinMonths' placeholder='Duration in Months: (Example: 6)' className="form-control" aria-describedby="emailHelp" required />
            </div>
